...
sub _create_temp {
    ...
    if ($table = $params{table}) {
        if (ref($table) eq 'CODE') {
            require DBIx::QuickORM::Builder;
            $table = DBIx::QuickORM::Builder::rogue_table($name => $table);
        }
...
See L<DBIx::QuickORM::Builder> for the primary interface documentation,
